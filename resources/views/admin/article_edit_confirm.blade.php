...
<body class="bg02">
    <div class="article-edit__confirm">
        <h2>コラム</h2>
        <form class="confirm-form" method="post" action="{{route('articleEditSubmit')}}" novalidate>
            @csrf
            ...
            <div class="article-section">
                <div class="article-description__confirm">
                    ...
                    <span class="article-section__p">{!! nl2br(e(session('article_description'))) !!}</span>
                </div>
            </div>
